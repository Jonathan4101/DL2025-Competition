...
USER_PRED_DIR = "/root/autodl-tmp/DL2025-Competition/Track1-WSSeg/experiments/results"      #请将grountruth修改为你保存图片的文件夹路径
OUTPUT_CSV = "/root/autodl-tmp/DL2025-Competition/Track1-WSSeg/experiments/results/submission.csv"    #submission_1.csv为程序运行后输出的csv文件保存路径
